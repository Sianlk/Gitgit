...
<img src="assets/graphics/icon-1024.svg" width="120" alt="GitGit Icon" />

# GitGit

### Ship Code. Not Confusion.

[![CI](https://github.com/Sianlk/Gitgit/actions/workflows/backend-ci.yml/badge.svg)](https://github.com/Sianlk/Gitgit/actions/workflows/backend-ci.yml)
[![Security Scan](https://github.com/Sianlk/Gitgit/actions/workflows/security-scan.yml/badge.svg)](https://github.com/Sianlk/Gitgit/actions/workflows/security-scan.yml)
[![License: MIT](https://img.shields.io/badge/License-MIT-blue.svg)](LICENSE)
[![Platform](https://img.shields.io/badge/platform-iOS%20|%20Android-lightgrey.svg)](https://gitgit.dev)
...
[Website](https://gitgit.dev) · [Privacy Policy](https://gitgit.dev/privacy) · [Support](https://gitgit.dev/support)
...
**GitGit** — Ship Code. Not Confusion.
...
- **AI-Powered Core** — Intelligent automation and recommendations tailored to git
...
```bash
# Clone the repo
git clone https://github.com/Sianlk/Gitgit.git
cd Gitgit
