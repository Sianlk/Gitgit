...
export default function AIScreen() {
  ...
  const [taskType, setTaskType] = useState('AI Commits');
  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      ...
      <Text style={styles.subtitle}>Domain: devops</Text>

      <Card variant="ai" style={styles.card}>
        <Text style={styles.label}>Task Type</Text>
        <ScrollView horizontal showsHorizontalScrollIndicator={false} style={styles.tagRow}>
          {['AI Commits','Smart PR Generator','Code Review AI','Branch Strategy','Release Notes AI'].map((f) => (
            <TouchableOpacity
              key={f}
