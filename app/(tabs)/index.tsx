...
const ACTIONS = [
  { id: '1', title: 'AI Commits', icon: 'sparkles-outline' },
  { id: '2', title: 'Smart PR Generator', icon: 'sparkles-outline' },
  { id: '3', title: 'Code Review AI', icon: 'sparkles-outline' },
  { id: '4', title: 'Branch Strategy', icon: 'sparkles-outline' },
  { id: '5', title: 'Release Notes AI', icon: 'sparkles-outline' },
];
