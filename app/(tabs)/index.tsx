...
const QUICK_ACTIONS = [
        { id: '1', title: 'AI Commits', icon: 'sparkles-outline', color: Colors.primary },
        { id: '2', title: 'Smart PR Generator', icon: 'sparkles-outline', color: Colors.primary },
        { id: '3', title: 'Code Review AI', icon: 'sparkles-outline', color: Colors.primary },
        { id: '4', title: 'Branch Strategy', icon: 'sparkles-outline', color: Colors.primary },
        { id: '5', title: 'Release Notes AI', icon: 'sparkles-outline', color: Colors.primary },
];
...
export default function HomeScreen() {
  ...
  async function handleAIQuery() {
    ...
    setLoading(true);
    Analytics.aiQuery(prompt, 'devops');
    try {
    ...
    <ScrollView style={styles.container} contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
      ...
      <View style={styles.header}>
        <View>
          ...
          <Text style={styles.tagline}>AI-powered git workflow automation</Text>
        </View>
      ...
      <Card variant="ai" style={styles.aiCard}>
        <View style={styles.aiBadge}>
          ...
          <Text style={styles.aiBadgeText}>AI — devops</Text>
        </View>
        <TextInput
          style={styles.aiInput}
          placeholder={`Ask GitGit AI anything...`}
