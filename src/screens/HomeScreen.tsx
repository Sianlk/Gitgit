    ...
    <SafeAreaView style={styles.container}>
      <ScrollView contentContainerStyle={styles.scroll}>
        <View style={styles.header}>
          ...
          <Text style={styles.tagline}>Ship Code. Not Confusion.</Text>
        </View>
        <View style={styles.section}>
          <Text style={styles.sectionTitle}>Quick Access</Text>
        <View key="0" style={styles.featureCard}>
          <Text style={styles.featureText}>Smart Git Workflows</Text>
        </View>
        <View key="1" style={styles.featureCard}>
          <Text style={styles.featureText}>AI Code Review</Text>
        </View>
        ...
        <View key="3" style={styles.featureCard}>
          <Text style={styles.featureText}>CI/CD Integration</Text>
        </View>
        </View>
        {user && (
