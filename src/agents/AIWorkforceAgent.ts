// AI Workforce Agent — GitGit
// Autonomous AI worker for devops
...
// Specialised AI agents for devops
const AGENT_PERSONAS = {
  analyst: {
    name: 'GitGit Analyst',
    role: `Expert devops analyst with deep knowledge of commit analysis, PR generation, code review, branch strategy.`,
    capabilities: ["AI Commits", "Smart PR Generator", "Code Review AI", "Branch Strategy", "Release Notes AI"],
  },
  advisor: {
    name: 'GitGit Advisor',
    role: `Senior devops advisor providing strategic recommendations.`,
    capabilities: ['Strategic planning', 'Risk assessment', 'Optimization'],
  },
  automator: {
    name: 'GitGit Automator',
    role: `Autonomous devops task executor and workflow manager.`,
