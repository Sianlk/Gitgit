// Monetization & Subscription Engine — GitGit
...
export const PLANS: Record<Plan, PlanConfig> = {
  ...
  starter: {
    ...
    price_monthly: 9.99,
    price_annual: 7.99,
    sku_monthly: 'com.sianlk.gitgit.starter.monthly',
    sku_annual: 'com.sianlk.gitgit.starter.annual',
    features: [
      '100 AI requests/day',
      'All devops features',
  ...
  pro: {
    ...
    price_monthly: 29.99,
    price_annual: 19.99,
    sku_monthly: 'com.sianlk.gitgit.pro.monthly',
    sku_annual: 'com.sianlk.gitgit.pro.annual',
    features: [
  ...
  enterprise: {
    ...
    price_monthly: 99.99,
    price_annual: 79.99,
    sku_monthly: 'com.sianlk.gitgit.enterprise.monthly',
    sku_annual: 'com.sianlk.gitgit.enterprise.annual',
    features: [
