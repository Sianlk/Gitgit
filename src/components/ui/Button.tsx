...
const styles = StyleSheet.create({
  ...
  // Variants
  variant_primary:   { backgroundColor: '#F97316' },
  variant_secondary: { backgroundColor: '#FB923C33' },
  variant_outline:   { backgroundColor: 'transparent', borderWidth: 1.5, borderColor: '#F97316' },
  variant_ghost:     { backgroundColor: 'transparent' },
  variant_danger:    { backgroundColor: Colors.error },
  variant_ai:        { backgroundColor: '#EA580C', borderWidth: 1, borderColor: '#FB923C' },

  // Labels
  label: { ...Typography.button },
  label_primary:   { color: '#FFFFFF' },
  label_secondary: { color: '#EA580C' },
  label_outline:   { color: '#F97316' },
  label_ghost:     { color: '#F97316' },
