...
const s = StyleSheet.create({
  ...
  v_primary:   { backgroundColor: '#F97316' },
  v_secondary: { backgroundColor: '#FB923C33' },
  v_outline:   { backgroundColor: 'transparent', borderWidth: 1.5, borderColor: '#F97316' },
  v_ghost:     { backgroundColor: 'transparent' },
  v_danger:    { backgroundColor: '#EF4444' },
  v_ai:        { backgroundColor: '#EA580C', borderWidth: 1, borderColor: '#FB923C' },
  lbl:    { fontSize: 14, fontWeight: '600' },
  lv_primary:   { color: '#FFFFFF' },
  lv_secondary: { color: '#EA580C' },
  lv_outline:   { color: '#F97316' },
  lv_ghost:     { color: '#F97316' },
